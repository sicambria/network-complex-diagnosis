...
class TestPingBurst:
    def test_all_success(self):
        ...
        with patch("netdiag_core.probes.ping.ping_once", mock_ping), \
    ...
    def test_some_loss(self):
        ...
        with patch("netdiag_core.probes.ping.ping_once", side_effect=returns), \
             patch("netdiag.time.sleep"), \
             patch("netdiag_core.runtime.now_iso", return_value="2025-01-01T00:00:00"), \
             patch("builtins.print"):
    ...
    def test_keyboard_interrupt_raises_userinterrupted(self):
        ...
        with patch("netdiag_core.probes.ping.ping_once", mock_ping), \
             ...
             patch("netdiag_core.runtime.now_iso", return_value="2025-01-01T00:00:00"), \
             patch("builtins.print"), \
             patch("netdiag_core.stats.series_stats"), \
             patch("netdiag_core.stats.jitter_ms"):
            import pytest
